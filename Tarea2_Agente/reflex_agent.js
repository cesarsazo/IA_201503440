...
function grafico(location, action_result, states) {
	if (location == "A") {
		if (states[1] == "DIRTY" && states[2] == "DIRTY" &&  action_result == "CLEAN") {
			setImage(1);
			state_1++;
		}else if (states[1] == "DIRTY"  && states[2] == "CLEAN") {
			setImage(3);
			state_3++;
		}else if (states[1] == "CLEAN"  && states[2] == "DIRTY" &&  action_result == "RIGHT") {
			setImage(5);
			state_5++;
